...
7. If scope was `branch` or an explicit PR target, push to the branch. If action plan was posted, leave a short follow-up comment noting findings were addressed and pushed; do not repost full plan.
